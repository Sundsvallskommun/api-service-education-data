...
public class PlannedEducationGymnasieTest {
	...
	@Test
	void testBean() {
		MatcherAssert.assertThat(PlannedEducationGymnasie.class, allOf(
	...
	void testNoDirtOnCreatedBean() {
		assertThat(PlannedEducationGymnasie.builder().build()).hasAllNullFieldsOrProperties();
		assertThat(new PlannedEducationGymnasie()).hasAllNullFieldsOrProperties();
	}
}
