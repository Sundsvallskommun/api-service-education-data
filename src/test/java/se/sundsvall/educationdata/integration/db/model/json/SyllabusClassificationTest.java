...
public class SyllabusClassificationTest {
	...
	@Test
	void testBean() {
		MatcherAssert.assertThat(SyllabusClassification.class, allOf(
	...
	void testNoDirtOnCreatedBean() {
		assertThat(SyllabusClassification.builder().build()).hasAllNullFieldsOrProperties();
		assertThat(new SyllabusClassification()).hasAllNullFieldsOrProperties();
	}
}
